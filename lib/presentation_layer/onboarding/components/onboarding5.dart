...
class OnboardingPage5 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        DefaultBar(),
        Image.asset(ImageAssets.fifth_onboarding,height: MediaQuery.of(context).size.height*0.37,width: MediaQuery.of(context).size.height*0.85 ,),
        SizedBox(height: 30,),
        DefaultText(title: S.of(context).onboarding5title, description: S.of(context).onboarding5description),
      ],
    );
  }
}
